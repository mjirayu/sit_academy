...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserInterestingTag'
        db.create_table('student_userinterestingtag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.UserProfile'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.Tag'])),
        ))
        db.send_create_signal('student', ['UserInterestingTag'])
        ...
        db.send_create_signal('student', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'UserInterestingTag'
        db.delete_table('student_userinterestingtag')
    ...
    models = {
        ...
        'student.userinterestingtag': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.UserProfile']"})
        },
        'student.userprofile': {
