  ...
  <div class="modal-dialog">\
    <div class="modal-content">\
      <div class="modal-header">\
        <h1 class="modal-title">Uploading</h1>\
      </div>\
      <div class="modal-body">\
        <div class="progress">\
          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0"\
               aria-valuemax="100" style="width: 0%;min-width: 2em; padding-top: 0.4em;">\
            0%\
          </div>\
        </div>\
        <div class="modal-footer">\
          <button type="button" class="btn btn-close-upload" data-dismiss="modal">Close</button>\
        </div>\
      </div>\
    </div>\
  </div>\
