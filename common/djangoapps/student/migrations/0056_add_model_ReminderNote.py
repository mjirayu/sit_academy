...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReminderNote'
        db.create_table('student_remindernote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_reminder_note', to=orm['student.UserProfile'])),
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('student', ['ReminderNote'])


    def backwards(self, orm):
        # Deleting model 'ReminderNote'
        db.delete_table('student_remindernote')
    ...
    models = {
        ...
        'student.remindernote': {
            'Meta': {'object_name': 'ReminderNote'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_reminder_note'", 'to': "orm['student.UserProfile']"})
        },
        'student.tag': {
        ...
        'student.userevent': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "'#8CE196'", 'max_length': '100'}),
            'end': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_event'", 'to': "orm['student.UserProfile']"})
        },
        'student.userinterestingtag': {
            'Meta': {'object_name': 'UserInterestingTag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.Tag']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_interesting_tag'", 'to': "orm['student.UserProfile']"})
        },
        'student.userprofile': {
